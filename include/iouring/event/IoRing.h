...
#include <iouring/core/Noncopyable.h>
#include <iouring/core/Error.h>
#include <iouring/event/RingBuffer.h>
...
class IoRing : public core::Noncopyable {
public:
    ...
    net::SessionManager& Sessions() noexcept { return session_manager_; }
    const net::SessionManager& Sessions() const noexcept { return session_manager_; }
...
private:
    ...
    net::SessionManager session_manager_;
